    ...
    <div class="main-wrapper">
        <div class="flex-container">
            ...
            <ul class="navigation__itens" id="menu">
                ...
                <li>
                    <a href="{{route('site.categoria')}}">Produtos
                        <span class="border-effect"></span>
                    </a>
                </li>
                <li>
...
<div id="resize">
    <ul id="menu">
        ...
        <li><a class="title-medium" href="{{route('site.categoria')}}">Produtos</a></li>
    ...
    <div class="main-wrapper flex-container">
        ...
        <ul>
            ...
            <li class="footer__links">
                ...
                <a href="{{route('site.categoria')}}">Nossos produtos</a>
